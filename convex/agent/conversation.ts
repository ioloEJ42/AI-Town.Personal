...
export async function continueConversationMessage(
  ...
  prompt.push(
    ...
    `DO NOT greet them again. Do NOT use the word "Hey" too often. Your response should be within 300 characters. The conversation is happening in-person at the company office.`,
  );
