...
export const CONVERSATION_COOLDOWN = 5000;
...
export const ACTIVITIES = [
  { description: 'checking teams', emoji: '📱', duration: 10_000 },
  { description: 'sending emails', emoji: '📨', duration: 10_000 },
  { description: 'on the phone', emoji: '📞', duration: 10_000 },
];
