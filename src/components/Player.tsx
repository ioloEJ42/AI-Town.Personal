...
export const Player = ({
  ...
  const isKnows =  (game.playerDescriptions.get(player.id)?.role === "2")
  const knowsNow =  (game.playerDescriptions.get(player.id)?.role === "3")
  const isShadow =  (game.playerDescriptions.get(player.id)?.role === "1")
